...
3. **Open another window**: File → New Window, then "Join Session" and enter the code
...
# Open DevTools (can't in production) → Console
...
- ❌ Record calls
- ❌ Keep logs permanently
- ❌ Require accounts/signup
- ❌ Share data with third parties
- ❌ Support 3+ participant calls (intentional privacy limit)
